...
#     header <- dashboardHeader(title = parameters$title)
#     , dashboardSidebar(
#         sidebarMenu(id = "tabs"
...
ui <- function(){shinyUI(fluidPage(
    ...
    , fluidRow(class="hc"
             , column(8,
                    h3("Secretaría de Educación",
                       tags$small("Matriculados de Bachillerato en el Huila"))),
             column(2, offset=2,
                    h5(a(href="http://sirhuila.gov.co"
                         , title="Inicio"
                         , img(src="logo.png"
                        , alt="Inicio"
                               ))))
